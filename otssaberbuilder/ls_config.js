		...
		var ls_config = new function() {
			...
			function Initializer () {
				...
				var loadBackground = (function () {
					...
					$("#ls_preload_img_background").one("load", function() {
			...
			User_Interface.prototype.createWindowDialogue = function (type) {
				...
				if (type == "info") {
					...
					$("#ls_dialogue_textcontainer").append("<div class='ls_dialogue_text'>The Unofficial OTS Saber Configutaion Tool allows you to build the saber of your dreams from parts of the HCCLS OTS line.</div>");
			...
			// Function to update image preview after color, mod or mod-color has changed
				...
				$("#ls_select_inspect_pictureInnerContainer").width("");
				$("#ls_select_inspect_pictureInnerContainer").width($("#ls_select_inspect_image").width());
				if (ui.select.selectedPart.flip) {
